...
entity arty_microblaze_01_wrapper is
  port (
...
end arty_microblaze_01_wrapper;

architecture STRUCTURE of arty_microblaze_01_wrapper is
  component arty_microblaze_01 is
  port (
    sys_clock : in STD_LOGIC;
    eth_ref_clk : out STD_LOGIC;
    reset : in STD_LOGIC;
...
begin
arty_microblaze_01_i: component arty_microblaze_01
     port map (
