...
proc create_hier_cell_switchboards { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.M06_S02_CONNECTIVITY {1} \
   CONFIG.M07_S00_CONNECTIVITY {0} \
...
proc create_hier_cell_s02_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MSC000_ROUTE {0b00000001} \
   CONFIG.MSC001_ROUTE {0b00000010} \
   CONFIG.MSC002_ROUTE {0b00000100} \
   CONFIG.MSC003_ROUTE {0b00001000} \
   CONFIG.MSC004_ROUTE {0b00010000} \
   CONFIG.MSC005_ROUTE {0b00100000} \
   CONFIG.MSC006_ROUTE {0b01000000} \
   CONFIG.MSC007_ROUTE {0b10000000} \
   CONFIG.MSC_ROUTE_WIDTH {8} \
   CONFIG.NUM_MSC {8} \
   ...
   CONFIG.SEG002_BASE_ADDR {0x0000000040600000} \
   ...
   CONFIG.SEG003_BASE_ADDR {0x0000000040E00000} \
   ...
   CONFIG.SEG004_BASE_ADDR {0x0000000041C00000} \
   ...
   CONFIG.SEG005_BASE_ADDR {0x0000000044A00000} \
   ...
   CONFIG.SEG006_BASE_ADDR {0x0000000080000000} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEP006_RDATA_WIDTH {128} \
   CONFIG.SEP006_WDATA_WIDTH {128} \
   CONFIG.SUPPORTS_NARROW {0} \
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M00_AXI:M01_AXI:M02_AXI:M03_AXI:M04_AXI:M05_AXI:M06_AXI:M07_AXI:S00_AXI:S01_AXI:S02_AXI} \
 ] $aclk
  ...
  connect_bd_net -net swbd_aclk_net [get_bd_pins clk_map/swbd_aclk] [get_bd_pins m00_nodes/s_axi_aclk] [get_bd_pins m01_nodes/s_axi_aclk] [get_bd_pins m02_nodes/s_axi_aclk] [get_bd_pins m03_nodes/s_axi_aclk] [get_bd_pins m04_nodes/s_axi_aclk] [get_bd_pins m05_nodes/s_axi_aclk] [get_bd_pins m06_nodes/s_axi_aclk] [get_bd_pins s00_nodes/m_sc_clk] [get_bd_pins s01_nodes/m_sc_clk] [get_bd_pins s02_nodes/m_sc_clk] [get_bd_pins switchboards/aclk]
  connect_bd_net -net swbd_aresetn_net [get_bd_pins clk_map/swbd_aresetn] [get_bd_pins m00_nodes/s_axi_aresetn] [get_bd_pins m01_nodes/s_axi_aresetn] [get_bd_pins m02_nodes/s_axi_aresetn] [get_bd_pins m03_nodes/s_axi_aresetn] [get_bd_pins m04_nodes/s_axi_aresetn] [get_bd_pins m05_nodes/s_axi_aresetn] [get_bd_pins m06_nodes/s_axi_aresetn] [get_bd_pins s00_nodes/m_sc_resetn] [get_bd_pins s01_nodes/m_sc_resetn] [get_bd_pins s02_nodes/m_sc_resetn] [get_bd_pins switchboards/aresetn]
