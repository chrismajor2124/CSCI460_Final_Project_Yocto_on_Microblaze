...
HD_PWD='C:/Vivado/projects/CSCI460/arty_linux.runs/arty_microblaze_01_auto_us_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_microblaze_01_auto_us_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_microblaze_01_auto_us_0.tcl
