...
HD_PWD='/home/teamradpc/Projects/CSCI_OS_Project/arty_linux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_microblaze_01_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_microblaze_01_wrapper.tcl
